...
if ! command -v rg >/dev/null 2>&1; then
  alias rg=''\''/Users/datdo/Library/Application Support/Zed/external_agents/claude-code-acp/0.4.0/node_modules/@anthropic-ai/claude-code/vendor/ripgrep/arm64-darwin/rg'\'''
fi
